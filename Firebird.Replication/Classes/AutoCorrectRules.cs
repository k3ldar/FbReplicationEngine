 ...
 *
 *  Purpose:  Automatic Correction Rules Collection
 *
 */
using System;
...
{
    public class AutoCorrectRules : CollectionBase
    {
        ...
        private const string OBJECT_TYPE = "Replication.Engine.Classes.AutoCorrectRule";
        private const string OBJECT_TYPE_ERROR = "Must be of type AutoCorrectRule";
